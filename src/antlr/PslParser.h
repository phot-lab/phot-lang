...
class  PslParser : public antlr4::Parser {
public:
  enum {
  ...
  explicit PslParser(antlr4::TokenStream *input);

  PslParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
